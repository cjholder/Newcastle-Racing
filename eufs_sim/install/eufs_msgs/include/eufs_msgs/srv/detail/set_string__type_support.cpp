...
{
  new (message_memory) eufs_msgs::srv::SetString_Request(_init);
}

void SetString_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<eufs_msgs::srv::SetString_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SetString_Request_message_member_array[1] = {
  {
    ...
    offsetof(eufs_msgs::srv::SetString_Request, data),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SetString_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(eufs_msgs::srv::SetString_Request),
...
{
  return &::eufs_msgs::srv::rosidl_typesupport_introspection_cpp::SetString_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, eufs_msgs, srv, SetString_Request)() {
  return &::eufs_msgs::srv::rosidl_typesupport_introspection_cpp::SetString_Request_message_type_support_handle;
}
...
void SetString_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) eufs_msgs::srv::SetString_Response(_init);
}

void SetString_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<eufs_msgs::srv::SetString_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SetString_Response_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(eufs_msgs::srv::SetString_Response, success),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(eufs_msgs::srv::SetString_Response, message),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SetString_Response_message_members = {
  ...
  2,  // number of fields
  sizeof(eufs_msgs::srv::SetString_Response),
...
{
  return &::eufs_msgs::srv::rosidl_typesupport_introspection_cpp::SetString_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, eufs_msgs, srv, SetString_Response)() {
  return &::eufs_msgs::srv::rosidl_typesupport_introspection_cpp::SetString_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers SetString_service_members = {
  ...
  // see get_service_type_support_handle<eufs_msgs::srv::SetString>()
...
get_service_type_support_handle<eufs_msgs::srv::SetString>()
{
  ...
  auto service_type_support =
    &::eufs_msgs::srv::rosidl_typesupport_introspection_cpp::SetString_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, eufs_msgs, srv, SetString)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<eufs_msgs::srv::SetString>();
}
