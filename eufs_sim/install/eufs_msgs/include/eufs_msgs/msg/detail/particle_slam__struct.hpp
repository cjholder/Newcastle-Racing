...
struct ParticleSLAM_
{
  ...
  using _particles_type =
    std::vector<eufs_msgs::msg::Particle_<ContainerAllocator>, typename ContainerAllocator::template rebind<eufs_msgs::msg::Particle_<ContainerAllocator>>::other>;
  ...
  Type & set__particles(
    const std::vector<eufs_msgs::msg::Particle_<ContainerAllocator>, typename ContainerAllocator::template rebind<eufs_msgs::msg::Particle_<ContainerAllocator>>::other> & _arg)
  {
    this->particles = _arg;
    return *this;
  }
