...
{
  new (message_memory) eufs_msgs::msg::StereoImage(_init);
}

void StereoImage_fini_function(void * message_memory)
{
  auto typed_message = static_cast<eufs_msgs::msg::StereoImage *>(message_memory);
  typed_message->~StereoImage();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember StereoImage_message_member_array[3] = {
  {
    "header",  // name
    ...
    offsetof(eufs_msgs::msg::StereoImage, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(eufs_msgs::msg::StereoImage, color),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(eufs_msgs::msg::StereoImage, depth),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers StereoImage_message_members = {
  ...
  3,  // number of fields
  sizeof(eufs_msgs::msg::StereoImage),
...
{
  return &::eufs_msgs::msg::rosidl_typesupport_introspection_cpp::StereoImage_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, eufs_msgs, msg, StereoImage)() {
  return &::eufs_msgs::msg::rosidl_typesupport_introspection_cpp::StereoImage_message_type_support_handle;
}
