...
struct ConeAssociationArray_
{
  ...
  using _matched_type =
    std::vector<eufs_msgs::msg::ConeAssociation_<ContainerAllocator>, typename ContainerAllocator::template rebind<eufs_msgs::msg::ConeAssociation_<ContainerAllocator>>::other>;
  ...
  Type & set__matched(
    const std::vector<eufs_msgs::msg::ConeAssociation_<ContainerAllocator>, typename ContainerAllocator::template rebind<eufs_msgs::msg::ConeAssociation_<ContainerAllocator>>::other> & _arg)
  {
    this->matched = _arg;
    return *this;
  }
