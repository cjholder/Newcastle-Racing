...
struct ConeArrayWithCovariancePlus_
{
  ...
  _header_type header;
  using _cones_type =
    std::vector<eufs_msgs::msg::ConeWithCovariancePlus_<ContainerAllocator>, typename ContainerAllocator::template rebind<eufs_msgs::msg::ConeWithCovariancePlus_<ContainerAllocator>>::other>;
  _cones_type cones;
  ...
  Type & set__cones(
    const std::vector<eufs_msgs::msg::ConeWithCovariancePlus_<ContainerAllocator>, typename ContainerAllocator::template rebind<eufs_msgs::msg::ConeWithCovariancePlus_<ContainerAllocator>>::other> & _arg)
  {
    this->cones = _arg;
    return *this;
  }
